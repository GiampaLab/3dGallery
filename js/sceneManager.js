...
// 		this.createDirectionalLight( 0xffeeaa, [ 830, 150 + offsety, -700 ]);
		this.createSpotLight( 0xffeeaa, 1, [ 830, 150 + offsety, -900 ], [ 350, 0 + offsety, -10000 ], false );
//		this.createSpotLight( 0xffeeaa, 1, [ 830, 150 + offsety, -500 ], [ 350, 0 + offsety, -600 ], false );

		// central lamp light
		this.createPointLight( 0xeeeeee, 1, 1500, [ -150.036, 200 + offsety, -172.72 ] );
//		this.createSpotLight( 0xffffff, 1, [ -150.036, 200 + offsety, -172.72 ], [ -150.036, 0 + offsety, -172.72 ], false );

		// sofa light
		this.createPointLight( 0xffffff, 1, 500, [ 419.5, 239 + offsety, 49.609 ] );
    		...
    		object.traverse( function ( child ) {
	      		...
	      		if ( child instanceof THREE.Mesh ) {
	 				...
	 				if (child.material.mapBump != null) {
	 					...
	 					newMaterial.normalScale = new THREE.Vector3( 2, 2, 2 );
